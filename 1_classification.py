# -*- coding: utf-8 -*-
"""
Created on Thu Apr  7 13:25:59 2022
...
for site in ['TLB','Ridge','CBH']: # 
    ...
    PATH_RES = r'C:\Users\nils\Documents\1_PhD\5_CHAPTER1\data\classification_data\{}\{}'.format(site,year)
    ...
    # Splitting the data into training and test data (stratify by the vegetation classes)
    seed = 0  # so that the result is reproducible
    labdat_train, labdat_test = train_test_split(labdat.loc[labdat.region == site],
                                                 test_size = .2, 
                                                 random_state = seed,
                                                 stratify = labdat.loc[labdat.region == site,'label'])
    ...
    if predict:
        ...
        new_dataset = rasterio.open( 
            PATH_OUT + '/{}_{}_classified_filtered{}.tif'.format(site,year,ncells),
            'w',    
            driver='GTiff',
